...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        ...
        <hr>
        <a href="<?=base_url('/vperf')?>" class="btn btn-sm btn-outline-primary offset-11"><i class="fa fa-eye" aria-hidden="true"></i> Performa</a>
        <div class="container col-md-4 mt-5">
		<div class="card">
			<div class="card-body">
				<form class="form" method="post" action="<?=base_url('/update_performa')?>">  
					<div class="input-group mb-3">
						<input type="hidden" name="id" value="<?=$performa[0]['id']?>">
					</div>
					<div class="input-group mb-3 col-sm-12">
						<span class="input-group-text" id="inputGroup-sizing-default">Customer</span>
						<input type="text" name="customer" value="<?=$performa[0]['customer']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group mb-3 col-sm-12">
						<span class="input-group-text" id="inputGroup-sizing-default">PO Num</span>
						<input type="text" name="po_no" value="<?=$performa[0]['po_no']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group mb-3 col-sm-12">
						<span class="input-group-text" id="inputGroup-sizing-default">PO Date</span>
						<input type="text" name="po_date" value="<?=$performa[0]['po_date']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group col-sm-12">
						<span class="input-group-text" id="inputGroup-sizing-default">Invoice Date</span>
						<input type="text" name="invoice_date" value="<?=$performa[0]['invoice_date']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>

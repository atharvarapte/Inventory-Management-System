...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history">V I E W &nbsp; O U T W A R D &nbsp; P R O D U C T S</h2>
              <hr>
              ...
              <table class="table table-hover align-content-md-center mt-3" id="item" style="width: 100%;">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  foreach ($items as $row) {?>
                    <tr>
                      ...
                      <td><?=$row['unit']?></td>
                      <td>
                        <button class="btn btn-outline-success" onclick="editOutProd(<?=$row['item_id']?>);">Edit</button>
                        <button class="btn btn-outline-danger" onclick="delOutProd(<?=$row['item_id']?>);">Delete</button>
                      </td>
                    </tr>
                  <?php }?>
                </tbody>
  ...
  <script>
    ...
    function viewOutProd() {
      //alert(id);
      window.location.href = "<?= base_url('/viewOutProd') ?>";
    }

    function editOutProd(id) {
      //alert(id);
      window.location.href = "<?= base_url('/edit_outward_product') ?>/" + id;
    }

    function delOutProd(id) {
      alert("Do you want to delete this product ?");
      window.location.href = "<?= base_url('/delete_outward_product') ?>/" + id;

        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item active">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=base_url('/reportout');?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p> Outward</p>
                </a>
              </li>
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history">C U S T O M E R &nbsp; R E P O R T</h2>
              <hr>
              <section class="content-header">
                <div class="container-fluid">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">GENERATE CUSTOMER REPORT</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                      <form method="GET">
              ...
              <table class="text-justify text-center table table-hover table-bordered" id="report">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <?php } else { ?>
                    <?php
                    $sql = "SELECT * FROM outward where customer='$customer'";
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        ...
                        if ($po_date <= $to && $po_date >= $from) {
                          // $query = "SELECT * FROM outward_items where id='$id'";                          
                          // echo $query;
                          $sql2 = "SELECT * FROM outward_items where id='$id'";

...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history">V I E W &nbsp; O U T W A R D</h2>
              <hr>
              <a href="<?= base_url('/add_outward') ?>" class="btn btn-sm btn-outline-primary offset-11"><i class="fa fa-plus"
                ...
                <tbody>
                  ...
                  foreach ($outward as $row) {?>
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-outline-primary" onclick="viewOutProd(<?=$row['id']?>);">View</button>
                      </td>
                      <td>
                        <button class="btn btn-outline-success" onclick="editOut(<?=$row['id']?>);"><i class="fas fa-edit"></i>
                          Edit</button>
                        <button class="btn btn-outline-danger" onclick="delOutward(<?=$row['id']?>);"><i
                            class="fa fa-trash" aria-hidden="true"></i> Delete</button>
                        <button class="btn btn-outline-secondary" onclick="invoice(<?=$row['id']?>);"><i
                            class="fa fa-download" aria-hidden="true"></i>Invoice</button>
                      </td>
                    </tr>
                  <?php }?>
                </tbody>
  ...
  <script>
    ...
    function viewOutProd(id) {
      //alert(id);
      window.location.href = "<?= base_url('/view_outward_products')?>/" + id;
    }

    function editOut(id) {
      //alert(id);
      window.location.href = "<?= base_url('/edit_outward') ?>/" + id;
    }

    function delOutward(id) {
      alert("Do you want to delete this outward ?");
      window.location.href = "<?= base_url('/delete_outward') ?>/" + id;

    }

    function invoice(id) {
      window.location.href = "<?= base_url('/outward_invoice') ?>/" + id;

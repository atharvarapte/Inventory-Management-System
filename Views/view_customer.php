...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history">V I E W &nbsp; C U S T O M E R S</h2>
              <hr>
              <a href="<?= base_url('/add_customer') ?>" class="btn btn-sm btn-outline-primary offset-10"><i class="fa fa-plus"
                  aria-hidden="true"></i>
                Add Customer</a>
                ...
                <tbody>
                  ...
                  foreach ($customers as $row ) {?>
                      <tr>
                        ...
                        <td><?=$row['gst_no']?></td>
                        <td>
                          <button class="btn btn-outline-success" onclick="editCust(<?=$row['id']?>);"><i class="fas fa-edit"></i>Edit</button>
                          <button class="btn btn-outline-danger" onclick="deleteCust(<?=$row['id']?>);"><i class="fa fa-trash" aria-hidden="true"><i>Delete</button>
                        </td>
                      </tr>
                  <?php }?>
  ...
  <script>
    ...
    function editCust(id) {
      //alert(id);
      window.location.href = "<?= base_url('/edit_customer')?>/" + id;
    }

    function deleteCust(id) {
      alert("Do you want to delete this product ?");
      window.location.href = "<?= base_url('/delete_customer') ?>/" + id;

...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history">V I E W &nbsp; I N W A R D</h2>
              <hr>
              <a href="<?= base_url('/add_inward') ?>" class="btn btn-sm btn-outline-primary offset-11"><i class="fa fa-plus"
                    ...
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-outline-primary"
                          onclick="viewInwardProd(<?=($row['id'])?>);">View</button>
                      </td>
                      <td>
                        <button class="btn btn-outline-success" onclick="editInward(<?=($row['id'])?>);"><i
                            class="fas fa-edit"></i> Edit</button>
                        <button class="btn btn-outline-danger" onclick="delInward(<?=($row['id'])?>);"><i
  ...
  <script>
    ...
    function viewInwardProd(id) {
      //alert(id);
      window.location.href = "<?= base_url('/view_inward_products') ?>/" + id;
    }

    function editInward(id) {
      //alert(id);
      window.location.href = "<?= base_url('/edit_inward') ?>/" + id;
    }

    function delInward(id) {
      alert("Do you want to delete this vendor ?");
      window.location.href = "<?= base_url('/delete_inward') ?>/" + id;

    }

    function invoice(id) {
      window.location.href = "<?= base_url('/inward_invoice') ?>/" + id;

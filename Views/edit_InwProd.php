      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history">E D I T &nbsp; I N W A R D &nbsp; P R O D U C T</h2>
              <hr>
              <a href="<?= base_url('/vinw') ?>" class="btn btn-outline-primary offset-11">Inward</a>
              <div class="card mt-4 mb-2 " style="width:40rem; height:33rem; margin: 0 auto;">
                <div class="card-body">
                  <form class="form" method="post" action="<?= base_url('/update_inward_product'); ?>">
                    <div class="input-group mb-4">
                      <input type="hidden" name="id" value="<?=$product[0]['id']?>">
                      <input type="hidden" name="item_id" value="<?=$product[0]['item_id']?>">
                    </div>
                    <div class="input-group mb-4 col-sm-8 offset-2">
                      <span class="input-group-text" id="inputGroup-sizing-default">Product</span>
                      <input type="text" name="prod" value="<?=$product[0]['product']?>" class="form-control">
                    </div>
                    <div class="input-group mb-4 col-sm-8 offset-2">
                      <span class="input-group-text" id="inputGroup-sizing-default">Quantity</span>
                      <input type="text" name="qty" value="<?=$product[0]['qty']?>" class="form-control">
                    </div>
                    <div class="input-group mb-4  col-sm-8 offset-2">
                      <span class="input-group-text" id="inputGroup-sizing-default">Rate</span>
                      <input type="text" name="rate" value="<?=$product[0]['rate']?>" class="form-control">
                    </div>
                    <div class="input-group mb-4  col-sm-8 offset-2">
                    ...
                    <div class="input-group mb-4  col-sm-8 offset-2">
                      ...
                      <input type="text" name="gst" value="<?=$product[0]['gst']?>" class="form-control">
                    </div>
                    <div class="input-group mb-4  col-sm-8 offset-2">
                      <span class="input-group-text" id="inputGroup-sizing-default">Unit</span>
                      <input type="text" name="unit" value="<?=$product[0]['unit']?>" class="form-control">
                    </div>
                    <button type="submit" class="btn btn-outline-success offset-5 mt-4">Update</button>
                  </form>
                </div>
              </div>

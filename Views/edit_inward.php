      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history">E D I T &nbsp; I N W A R D</h2>
              <hr>
              <a href="<?= base_url('/view_inward') ?>" class="btn btn-outline-primary offset-11">Inward</a>
              <div class="card mt-4 mb-2 " style="width:40rem; height:25rem; margin: 0 auto;">
                <div class="card-body">
                  <form class="form" method="post" action="<?= base_url('/update_inward'); ?>">
                    <div class="input-group mb-4">
                      <input type="hidden" name="id" value="<?=$inward[0]['id']?>">
                    </div>
                    <div class="input-group mb-4 col-sm-8 offset-2">
                      <span class="input-group-text" id="inputGroup-sizing-default">Customer</span>
                      <input type="text" name="vendor" value="<?=$inward[0]['vendor']?>" class="form-control">
                    </div>
                    <div class="input-group mb-4 col-sm-8 offset-2">
                      <span class="input-group-text" id="inputGroup-sizing-default">PO Num</span>
                      <input type="text" name="po_no" value="<?=$inward[0]['po_no']?>" class="form-control">
                    </div>
                    <div class="input-group mb-4  col-sm-8 offset-2">
                      <span class="input-group-text" id="inputGroup-sizing-default">PO Date</span>
                      <input type="date" name="po_date" value="<?=$inward[0]['po_date']?>" class="form-control">
                    </div>
                    <div class="input-group col-sm-8 offset-2">
                      <span class="input-group-text" id="inputGroup-sizing-default">Invoice Date</span>
                      <input type="date" name="invoice_date" value="<?=$inward[0]['invoice_date']?>"
                        class="form-control">
                    </div>
                    <button type="submit" class="btn btn-outline-success offset-5 mt-5">Update</button>
                  </form>
                </div>
              </div>

...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url('/add_customer');?>" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h2 id="history">G E N E R A T E &nbsp; C U S T O M E R</h2>
        <hr>
        <a href="<?=base_url('/view_customer')?>" class="btn btn-sm btn-outline-primary offset-10"><i class="fa fa-eye" aria-hidden="true"></i>
Customers</a>
  ...
  <div class="container-fluid">
   <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <div class="card-body">
         <form method="POST" action="<?=base_url('/add_cust')?>">
            <div class="row">
               <div class="col-sm-4">
                  <!-- text input -->
            ...
            <div class="form-group">
               <!-- textarea -->
                  <div class="form-group">  
                      <button type="submit" class="btn btn-outline-primary mt-4">Add Customer</button>
                  </div>
            </div>
           </div> 
         </form>

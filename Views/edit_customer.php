...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=base_url('/view_customer');?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Customer</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h2 id="history">E D I T  &nbsp; C U S T O M E R S </h2>
        <hr>
        <a href="<?=base_url('/view_customer')?>" class="btn btn-sm btn-outline-primary offset-11">BACK</a>
        <div class="container col-md-5 mt-5">
		<div class="card">
			<div class="card-body">
				<form class="form" method="post" action="<?=base_url('/update_customer');?>">
					<div class="input-group mb-3">
						<input type="hidden" name="id" value="<?=$customer[0]['id']?>">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">Customer</span>
						<input type="text" name="customer" id="acustomer" value="<?=$customer[0]['name']?>" class="form-control">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">Address</span>
						<input type="text" id="aaddress" name="address" value="<?=$customer[0]['address']?>" class="form-control">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">Contact Person</span>
						<input type="text" name="contact_person" id="acp" value="<?=$customer[0]['contact_person']?>" class="form-control">
					</div>
                    <div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">Number</span>
						<input type="text" name="number" id="anumber" value="<?=$customer[0]['number']?>" class="form-control">
					</div>
                    <div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">Email</span>
						<input type="text" name="email" id="aemail" value="<?=$customer[0]['email']?>" class="form-control">
					</div>
                    <div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">GST No</span>
						<input type="text" name="gst_no" id="agst" value="<?=$customer[0]['gst_no']?>" class="form-control">
					</div>
...
<script>
    ...
    function editProd(id){
        //alert(id);
        window.location.href="<?=base_url('/editProd')?>/"+id;
    }

    function delProd(id){
        alert("Do you want to delete this product ?");
        window.location.href="<?=base_url('/delProd')?>/"+id;

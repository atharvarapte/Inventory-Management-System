...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h2 id="history">G E N E R A T E &nbsp; O U T W A R D</h2>
        <hr>
        <a href="<?=base_url('/view_outward')?>" class="btn btn-outline-primary offset-11"><i class="fa fa-eye" aria-hidden="true"></i> Outward</a>
        <section class="content-header">
    <div class="container-fluid">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Add Outward Stock</h3>
        </div>
      <!-- /.card-header -->
        <div class="card-body" >
        <form method="POST" action="<?=base_url('/add_out')?>">
        <div class="row">
        <div class="col-sm-4">
            ...
            <div class="col-sm-4 mt-3">
                ...
                <td><input id="pc" style="width: 125px; height: 35px;"  type='text' name='partcode[]' value="<?php ?>" readonly></td>
                ...
                <td>
                  <input id="unit" style="width: 200px;" type='text' name='unit[]' readonly>
                </td>

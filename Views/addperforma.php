...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url('/add_performa');?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h2 id="history">G E N E R A T E &nbsp; P E R F O R M A</h2>
        <hr>
        <a href="<?=base_url('/view_performa')?>" class="btn btn-outline-primary offset-11"><i class="fa fa-eye" aria-hidden="true"></i> Performa</a>
        <section class="content-header">
    <div class="container-fluid">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Add Performa</h3>
        </div>
      <!-- /.card-header -->
        <div class="card-body" >
        <form method="POST" action="<?=base_url('/add_perf');?>">
        <div class="row">
        <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <select class="form-select mb-3" name="customer">
                      ...
                      <?php foreach ($vendor as $row): ?>
                        <option><?php print_r($row['name']);?></option>
                      <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" placeholder="Enter Purchase Outward Number" name="po_date" required="">
                </div>
            </div>
            ...
            <div class="col-sm-4">
                ...
                <label>Invoice Date</label>
                    <input type="date" class="form-control" placeholder="Enter Invoice Date" name="invoice_date" required="">
                </div>
            </div>
            ...
            <div class="col-sm-4 mt-3">
                <table class="text-justify text-center table table-bordered" onforminput="" id="item">
                    <thead>
						...
						<tbody>
							...
							<tr>
                <td>
                    <select class="form-select" name='prod[]' style="width: 160px;">
                ...
                <td><input style="width: 125px; height: 35px;"  type='text' name='partcode[]' value="<?php ?>"></td>
                ...
                <td>
                  <select class="form-select" style="width: 200px;" type='text' name='unit[]'>
                ...
                <td><button type="button" name="add_customer" class="btn btn-sm btn-outline-primary" onclick="add();"><i class="fa fa-plus" aria-hidden="true"></i></button></td>
							</tr>
            ...
            <div class="form-group">
               <button class="btn btn-outline-success mt-3" onclick="addinw();" type="submit">Submit</button>
            </div>
            <div class="form-group">
               <!-- textarea -->
...
<script>
    function add(){
        $row = $("#item tr").length;
        $row = $row + 1;
        $("#item tr:last").after("<tr id='row"+$row+"'><td><select class='form-select' name='prod[]' style='width: 160px;'><option selected>Select Products</option><?php foreach ($products as $row): ?><option><?php print_r($row['name']);?></option><?php endforeach; ?></select></td><td><input style='width: 125px; height: 35px;' type='text' name='partcode[]'></td><td><input style='width: 125px; height: 35px;' type='text' name='qty[]'></td><td><input style='width: 150px; height: 35px;' type='text' name='rate[]'></td><td><input style='width: 150px; height: 35px;' type='text' name='freight[]'></td><td><input style='width: 100px; height: 35px;' type='text' name='gst[]'></td><td>    <select class='form-select' style='width: 200px;' type='text' name='unit[]'><option selected>Unit</option><option>No.</option><option>Nos</option><option>Mtr</option><option>Lot</option></select></td><td><input type='button' class='mx-2 btn btn-sm btn-outline-danger' value='Delete' onclick=del('row"+$row+"')></td></tr>");
    } 

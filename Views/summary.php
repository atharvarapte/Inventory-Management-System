      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?= base_url('/summary'); ?>" class="nav-link active">
                <i class="nav-icon fas fa-arrow-circle-right"></i>
                <p>Stock Summary<i class="fas"></i></p>
              </a>
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history"> S T O C K &nbsp; S U M M A R Y </h2>
              <hr>
              <table class="table table-hover align-content-md-center table-bordered mt-4" id="item">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  foreach ($products as $row) {?>
                    <tr>
                      <td><?=$no++?></td>
                      <td><?=$row['product']?></td>
                      <?php if(!empty($sold[$no -2]['qty'])){?>
                      <td><?=$stock[$no - 2]['qty'] - $sold[$no -2]['qty']?></td>
                      <?php } else { ?>
                      <td><?=$stock[$no - 2]['qty']?></td>
                      <?php }?>
                      <?php if (!empty($sold[$no -2]['qty'])) {?>
                        <td><?=$sold[$no -2]['qty']?></td>
                      <?php } else {?>

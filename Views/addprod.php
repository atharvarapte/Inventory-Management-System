...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url('/add_product');?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h2 id="history">G E N E R A T E &nbsp; P R O D U C T S</h2>
        <hr>
        <a href="<?=base_url('/view_product')?>" class="btn btn-sm btn-outline-primary offset-11"><i class="fa fa-eye" aria-hidden="true"></i>
Products</a>
      ...
      <div class="card-body">
         <form method="POST" action="<?=base_url('/add')?>">
            <div class="row">
               ...
               <div class="col-sm-4">
                  ...
                  <label>Part Code</label>
                     <input class="form-control" placeholder="Enter Address Line" name="partcode" required="">
                </div>
               </div>
               ...
               <div class="col-sm-4">
                  <div class="form-group">
                  <label>UNIT</label>
                     <select type="text" class="form-select" name="unit">
            ...
            <div class="form-group">
               <!-- textarea -->
                  <div class="form-group">  
                      <button type="submit" name="add_customer" onclick="addProd();" class="btn btn-outline-primary mt-4">Add Product</button>
                  </div>
            </div>
           </div> 
         </form>

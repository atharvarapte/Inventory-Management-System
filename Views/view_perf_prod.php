...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        ...
        <hr>
        <a href="<?=base_url('/add_performa')?>" class="btn btn-sm btn-outline-primary offset-11"><i class="fa fa-plus" aria-hidden="true"></i> Generate</a>
        <table class="table table-hover align-content-md-center mt-4" id="item" style="width: 100%;">
		  <thead>
		    <tr>
        ...
        foreach ($items as $row) {?>
          <tr>
            ...
            <td><?=$row['unit']?></td>
            <td>
              <button class="btn btn-outline-success" onclick="editPerformaProd(<?=$row['item_id']?>);">Edit</button>
              <button class="btn btn-outline-danger" onclick="delPerformaProd(<?=$row['item_id']?>);">Delete</button>
            </td>
          </tr>
        <?php }?>
				</tbody>
...
<script>
    ...
    function viewPerfProd(){
        //alert(id);
        window.location.href="<?=base_url('/viewPerfProd')?>";
    }

    function editPerformaProd(id){
        //alert(id);
        window.location.href="<?=base_url('/edit_performa_product')?>/" + id;
    }

    function delPerformaProd(id){
        alert("Do you want to delete this vendor ?");
        window.location.href="<?=base_url('/delete_performa_product')?>/"+id;

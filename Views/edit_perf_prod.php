...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h2 id="history">E D I T &nbsp; P E R F O R M A</h2>
        <hr>
        <a href="<?=base_url('/view_performa')?>" class="btn btn-sm btn-outline-primary offset-11"><i class="fa fa-eye" aria-hidden="true"></i> Performa</a>
        <div class="container col-md-6 mt-5">
		    <div class="card">
			<div class="card-body">
				<form class="form" method="post" action="<?=base_url('/update_performa_product')?>">
					<div class="input-group mb-3">
            <input type="hidden" name="id" value="<?=$product[0]['id']?>">
						<input type="hidden" name="item_id" value="<?=$product[0]['item_id']?>">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">Product</span>
						<input type="text" name="prod" value="<?=$product[0]['product']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">Quantity</span>
						<input type="text" name="qty" value="<?=$product[0]['qty']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">Rate</span>
						<input type="text" name="rate" value="<?=$product[0]['rate']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">Freight</span>
						<input type="text" name="freight" value="<?=$product[0]['freight']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">GST</span>
						<input type="text" name="gst" value="<?=$product[0]['gst']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group">
						<span class="input-group-text" id="inputGroup-sizing-default">Unit</span>
						<input type="text" name="unit" value="<?=$product[0]['unit']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<button type="submit" class="btn btn-success offset-5 mt-2" >Update</button>
				</form>
			</div>
		</div>
        <?php // endforeach; ?>
...
<script>
    ...
    function editInward(id){
        //alert(id);
        window.location.href="<?=base_url('/editinw')?>/"+id;
    }

    function delInward(id){
        alert("Do you want to delete this vendor ?");
        window.location.href="<?=base_url('/delInw')?>/"+id;

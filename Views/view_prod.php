...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history">V I E W &nbsp;P R O D U C T S</h2>
              <hr>
              <a href="<?= base_url('/add_product') ?>" class="btn btn-sm btn-outline-primary offset-10"><i class="fa fa-plus"
                  aria-hidden="true"></i>
                Add Product</a>
                ...
                <tbody>
                  ...
                  foreach($items as $row) {?>
                      <tr>
                        ...
                        <td><?= $row['unit'] ?></td>
                        <td>
                          <button class="btn btn-outline-success" onclick="editProd(<?=$row['id']?>);"><i
                              class="fas fa-edit"></i> Edit</button>
                          <button class="btn btn-outline-danger" onclick="deleteProd(<?=$row['id']?>);"><i
  ...
  <script>
    function editProd(id) {
      //alert(id);
      window.location.href = "<?=base_url('/edit_product')?>/" + id;
    }

    function deleteProd(id) {
      alert("Do you want to delete this product ?");
      window.location.href = "<?= base_url('/delete_product') ?>/" + id;

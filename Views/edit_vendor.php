      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history">E D I T &nbsp; V E N D O R</h2>
              <hr>
              <a href="<?= base_url('/view_vendor') ?>" class="btn btn-outline-primary offset-11">Vendors</a>
              <div class="container col-md-6 mt-5">
                <div class="card">
                  <div class="card-body">
                    <form class="form" method="post" action="<?= base_url('/update_vendor'); ?>">
                      <div class="input-group mb-3">
                        <input type="hidden" name="id" value="<?=($vendor[0]['id']) ?>">
                      </div>
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Customer</span>
                        <input type="text" name="name" value="<?=($vendor[0]['name']) ?>" class="form-control">
                      </div>
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Address</span>
                        <input type="text" name="address" value="<?=($vendor[0]['address']) ?>" class="form-control">
                      </div>
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Contact Person</span>
                        <input type="text" name="contact_person" value="<?=($vendor[0]['contact_person']) ?>"
                          class="form-control">
                      </div>
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Number</span>
                        <input type="text" name="number" value="<?=($vendor[0]['number']) ?>" class="form-control">
                      </div>
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Email</span>
                        <input type="email" name="email" value="<?=($vendor[0]['email']) ?>" class="form-control">
                      </div>
                      <div class="input-group">
                        <span class="input-group-text" id="inputGroup-sizing-default">GST No</span>
                        <input type="text" name="gst_no" value="<?=($vendor[0]['gst_no']) ?>" class="form-control">
                      </div>

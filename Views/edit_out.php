...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url('/add_outward');?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <h2 id="history">E D I T &nbsp; O U T W A R D</h2>
        <hr>
        <a href="<?=base_url('/view_outward')?>" class="btn btn-sm btn-outline-primary offset-11"><i class="fa fa-eye" aria-hidden="true"></i> Outwards</a>
        <div class="container col-md-6 mt-5">
		<div class="card">
			<div class="card-body">
				<form class="form" method="post" action="<?=base_url('/update_outward')?>">  
					<div class="input-group mb-3">
						<input type="hidden" name="id" value="<?=$outward[0]['id']?>">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">Customer</span>
						<input type="text" name="customer" value="<?=$outward[0]['customer']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">PO Num</span>
						<input type="text" name="po_no" value="<?=$outward[0]['po_no']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="inputGroup-sizing-default">PO Date</span>
						<input type="date" name="po_date" value="<?=$outward[0]['po_date']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<div class="input-group">
						<span class="input-group-text" id="inputGroup-sizing-default">Invoice Date</span>
						<input type="date" name="invoice_date" value="<?=$outward[0]['invoice_date']?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
					</div>
					<button type="submit" class="btn btn-outline-success offset-5 mt-2">Update</button>
				</form>
			</div>
		</div>

        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=base_url('/view_outward');?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Outward</p>
                </a>
              </li>
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="container">
              <h2 id="history">E D I T &nbsp; O U T W A R D &nbsp; P R O D U C T</h2>
              <hr>
              <a href="<?= base_url('/vout') ?>" class="btn btn-sm btn-outline-primary offset-11"><i class="fa fa-eye"
                  aria-hidden="true"></i> Outwards</a>
              <div class="container col-md-6 mt-5">
                <div class="card">
                  <div class="card-body">
                    <form class="form" method="post" action="<?=base_url('update_outward_product')?>">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input type="text" name="prod" value="<?=$product[0]['product']?>" class="form-control" aria-label="Sizing example input"
                          aria-describedby="inputGroup-sizing-default">
                      </div>
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Quantity</span>
                        <input type="text" name="qty" value="<?=$product[0]['qty']?>" class="form-control" aria-label="Sizing example input"
                          aria-describedby="inputGroup-sizing-default">
                      </div>
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Rate</span>
                        <input type="text" name="rate" value="<?=$product[0]['rate']?>" class="form-control" aria-label="Sizing example input"
                          aria-describedby="inputGroup-sizing-default">
                      </div>
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Freight</span>
                        <input type="text" name="freight" value="<?=$product[0]['freight']?>" class="form-control"
                          aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                      </div>
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">GST</span>
                        <input type="text" name="gst" value="<?=$product[0]['gst']?>" class="form-control" aria-label="Sizing example input"
                          aria-describedby="inputGroup-sizing-default">
                      </div>
                      <div class="input-group">
                        <span class="input-group-text" id="inputGroup-sizing-default">Unit</span>
                        <input type="text" name="unit" value="<?=$product[0]['unit']?>" class="form-control" aria-label="Sizing example input"
                          aria-describedby="inputGroup-sizing-default">
                      </div>
